...
class UserServiceTest {
    ...
    void getCompanyDriverByHubIdWillSuccess() {
        ...
        Page<User> page = new PageImpl<>(List.of(user));
        when(userRepository.findCompanyDriverByHubId(pageable, hubId)).thenReturn(page);

        Page<CompanyDriverResult> result = userService.getCompanyDriverByHubId(pageable, hubId);
    ...
    void getHubDriverByHubIdWillSuccess() {
        ...
        user.approve(target, UserStatus.APPROVED);
        Page<User> page = new PageImpl<>(List.of(user));
        when(userRepository.findHubDriverByHubId(pageable)).thenReturn(page);

        Page<HubDriverResult> result = userService.getHubDriverByHubId(pageable);
    ...
    void getHubManagerByHubIdWillSuccess() {
        ...
        user.approve(target, UserStatus.APPROVED);
        Page<User> page = new PageImpl<>(List.of(user));
        when(userRepository.findHubManagerByHubId(pageable, hubId)).thenReturn(page);

        Page<HubManagerResult> result = userService.getHubManagerByHubId(pageable, hubId);
    ...
    void getCompanyManagerByCompanyIdWillSuccess() {
        ...
        user.approve(target, UserStatus.APPROVED);
        Page<User> page = new PageImpl<>(List.of(user));
        when(userRepository.findCompanyManagerByCompanyId(pageable, companyId)).thenReturn(page);

        Page<CompanyManagerResult> result = userService.getCompanyManagerByCompanyId(pageable, companyId);
